...
//       // console.log('tabdata = true');
//       this.cards = document.querySelectorAll('.card');
//     } else  {
//       // else if `all` is false, only select the cards with matching this.tabData values
//        this.cards = document.querySelectorAll(`.cards[data-tab ='${this.tabData}']`);
//       //  console.log(`.cards[data-tab ='${this.tabData}']`);
//       // console.log('tabdata = false');
//     }
//     console.log(this.cards, 'pre-map');
...
//      console.log('should add active tab')
...
//     // console.log(cardElement, 'this is cardElement');
//   }
//   selectCard(){
//     // Update the style of this.cardElement to display = "flex"
//     this.cardElement.style.display = 'flex';
//     console.log('should update card to flex');
//   }
